...
print >>g, "#cylinder(h = 25.4*1, r1 = 25.4*23, r2 = 25.4*23);"
print >>g, "//take out keyhole and center"
print >>g, "#rotate(a=45, v=[0,0,1]){"
print >>g, "cube(size=[25.4*48, 25.4*48, 25.4*1]);"
print >>g, "}"
print >>g, "#cylinder(h = 25.4*1, r1 = 25.4*19, r2 = 25.4*19);"
print >>g, "}"


with open('dimensions_upper.txt', 'rU') as f:
	...
	if case_control == 0:
		print >>g, "translate([0,0,21*25.4])"
		print >>g, "rotate(a=(270 +",rotoff,"), v=[0,0,1]){"
		print >>g, "rotate(a=-incline, v=[0,1,0]){"
		print >>g, "translate ([ ((25.4*19)/cos(incline)) , -25.4*2, 0]) "
		...
		#print >>g, "translate([0,0,4*25.4])" original
		print >>g, "translate([0,0,21*25.4])"
		print >>g, "rotate(a=(270 -",rotoff,"), v=[0,0,1]){"
		print >>g, "rotate(a=-incline, v=[0,1,0]){"
		print >>g, "translate ([ ((25.4*19)/cos(incline)) , -25.4*2, 0]) "
